        ...
        <div class="row">
               ...
               <c:when test="${group_no eq 10 || group_no eq 40 }">
                  <div class="sidebar">
                     ...
                     <ul class="list-group list-group-flush mb-5">
                        ...
                        <li id="post10" class="list-group-item"><a href="notice_list?group=10">공지사항</a></li>
         ...
         <div class="col-md-9">
            ...
            <div class="col pb-4">
               ...
               <c:if test="${group_no==10&&sUserId==1 }">
              ...
              <c:if test="${empty sUserId }">
               ...
               <table class="table table-hover">
                  ...
                  <tbody class="tbody text-center noto-sans">
                     ...
                     <c:forEach var="notice" items="${notice_list.itemList}">
	                                    <tr>
	                                    <!-- 
			                    ...
			                    <div class="shop_pagination_area mt-5">
			                        <nav aria-label="Page navigation">
			                            <ul class="pagination pagination-sm justify-content-center">
			                            	...
			                            	<c:if test="${notice_list.pageMaker.prevPage > 0}">  
				            					<li class="page-item">
				                                    <button class="page-link" onclick="changeQnaList(${data.pageMaker.prevPage});"><i class="fa fa-angle-left" aria-hidden="true"></i></button>
				                               	 </li>
			                                </c:if>
			                                <c:forEach var="no" begin="${notice_list.pageMaker.blockBegin}" end="${notice_list.pageMaker.blockEnd}">
												<c:if test="${notice_list.pageMaker.curPage == no}">
			                                ...
			                                <c:if test="${notice_list.pageMaker.curPage < noticeList.pageMaker.totPage}">  
				                                <li class="page-item">
							                        <button class="page-link" onclick="changeQnaList(${notice_list.pageMaker.nextPage})"><i class="fa fa-angle-right" aria-hidden="true"></i></button>
						                    	 </li>
			                                </c:if>
