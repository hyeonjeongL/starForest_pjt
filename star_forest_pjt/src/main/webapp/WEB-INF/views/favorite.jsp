...
<head>
	...
	<title>별숲 도서관</title>
	<link rel="alternate" hreflang="ko" href="https://library.korea.ac.kr/my-library/private-library/" />
<link rel="alternate" hreflang="en" href="https://library.korea.ac.kr/my-library/private-library/?lang=en" />

<!-- WordPress KBoard plugin 5.8 - https://www.cosmosfarm.com/products/kboard -->
<link rel="alternate" href="https://library.korea.ac.kr/wp-content/plugins/kboard/rss.php" type="application/rss+xml" title="별숲 도서관 &raquo; KBoard 통합 피드">
<!-- WordPress KBoard plugin 5.8 - https://www.cosmosfarm.com/products/kboard -->
...
<link rel="https://api.w.org/" href="https://library.korea.ac.kr/wp-json/" /><link rel="alternate" type="application/json" href="https://library.korea.ac.kr/wp-json/wp/v2/pages/617" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://library.korea.ac.kr/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="https://library.korea.ac.kr/wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 5.5.10" />
<link rel="canonical" href="https://library.korea.ac.kr/my-library/private-library/" />
<link rel='shortlink' href='https://library.korea.ac.kr/?p=617' />
<link rel="alternate" type="application/json+oembed" href="https://library.korea.ac.kr/wp-json/oembed/1.0/embed?url=https%3A%2F%2Flibrary.korea.ac.kr%2Fmy-library%2Fprivate-library%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://library.korea.ac.kr/wp-json/oembed/1.0/embed?url=https%3A%2F%2Flibrary.korea.ac.kr%2Fmy-library%2Fprivate-library%2F&#038;format=xml" />
...
<body class="page-template-default page page-id-617 page-child parent-pageid-157 logged-in wp-custom-logo wp-embed-responsive has-fixed-top singular image-filters-enabled elementor-default elementor-kit-14083">
			...
			<div class="row justify-content-between align-items-center">
				<div class="col-2 col-lg-4 order-1">
					...
					<div class="aside-menu-item user-menu-item">
						...
						<div class="user-menu">
							<div>
								<a href="/logout/?returl=%2Fmy-library%2Fprivate-library%2F">LOGOUT								(2020010688)</a>
							</div>
							<div>
							...
							<div>
								<a class="d-flex justify-content-between align-items-center" href="/my-library/loan/loan-list/">
									...
									<span>0</span>
										...
										<a href="/my-library/private-library/?&lang=en" class="aside-menu-item">ENG</a>
...
<li class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children"><a >나의공간<small class="menu-item-description">개인화 서비스 메뉴로 로그인한 개인별 도서관 이용 현황을 통합해서 제공합니다.</small></a> <small class="nav-desc">개인화 서비스 메뉴로 로그인한 개인별 도서관 이용 현황을 통합해서 제공합니다.</small>
<ul class="sub-menu">
...
<li class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children"><a >내정보</a> 
	<ul class="sub-menu">
<li class="mobile-parent-nav-menu-item"><a >내정보</a> </li>
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-617 current_page_item"><a  href="https://library.korea.ac.kr/my-library/private-library/">내서재</a> </li>
...
<li id="menu-item-39" class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children menu-item-39"><a>나의공간<small class="menu-item-description">개인화 서비스 메뉴로 로그인한 개인별 도서관 이용 현황을 통합해서 제공합니다.</small></a>
<ul class="sub-menu">
	...
	<li id="menu-item-109" class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-109"><a>내정보</a>
	<ul class="sub-menu">
		<li id="menu-item--29" class="mobile-parent-nav-menu-item menu-item--29"><a>내정보</a></li>
		<li id="menu-item-651" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-617 current_page_item menu-item-651"><a href="https://library.korea.ac.kr/my-library/private-library/" aria-current="page">내서재</a></li>
...
<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to 별숲 도서관." href="https://library.korea.ac.kr" class="home" ><span property="name">HOME</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to 나의 공간." href="https://library.korea.ac.kr/my-library/" class="post post-page" ><span property="name">나의 공간</span></a><meta property="position" content="2"></span> &gt; <span class="post post-page current-item">내서재</span>					</div><!-- .entry-nav -->
				...
				<div class="col-lg-9">
					...
					<div class="items-header directory-header d-flex justify-content-lg-between align-items-baseline">
						...
						<div class="item-count">
							<span class="number">0</span>건						</div>
					</div><!-- .items-header -->
					...
					<div class="e-items list">
						...
						<div class="e-item item-headings d-none d-xl-flex align-items-center">
							...
							<div class="item-functions">삭제</div>
						</div><!-- .item-headings -->
...
<li class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children menu-item-39"><a>나의공간<small class="menu-item-description">개인화 서비스 메뉴로 로그인한 개인별 도서관 이용 현황을 통합해서 제공합니다.</small></a>
<ul class="sub-menu">
	<li class="blank-node menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-109"><a>내정보</a>
	<ul class="sub-menu">
		<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-617 current_page_item menu-item-651"><a href="https://library.korea.ac.kr/my-library/private-library/" aria-current="page">내서재</a></li>
