...
insert into book_club values(SEQ_book_club_club_no.nextval,'미스터실록',8,'경제에 관심있는 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','경제경영 토론 및 주제 분석 등 경제경영에 대해 심도있게 공부하실 분들 환영합니다!',2,200,'hyeonjeong');
insert into book_club values(SEQ_book_club_club_no.nextval,'똑소리나는 경제경영',8,'경제/경영 활동이 필요한 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','경제/경영 책들을 읽으며 서로에게 도움되는 정보들 공유해요!',2,200,'soyoon');
insert into book_club values(SEQ_book_club_club_no.nextval,'티끌모아 태산',8,'경제에 관심있는 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','빈털털이라고 좌절하지마세요! 함께 공부하며 부자됩시다~',2,200,'yeji');
...
insert into book_club values(SEQ_book_club_club_no.nextval,'역사읽기',8,'역사에 관심있는 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','고려시대 위주의 도서들 읽으며 정보교환하고 이야기나누어요!',2,300,'soyoon');

insert into book_club values(SEQ_book_club_club_no.nextval,'중학생들 다 모여',10,'정보교류를 좋아하는 중학생','매주 토요일 오전 11시','평화의 광장','책정보 교류 및 토론하며 지식 쌓아가요:)',5,400,'junghyun');
insert into book_club values(SEQ_book_club_club_no.nextval,'물리학을 사랑하는 모임',8,'물리에 관심있는 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','물리현상에 대해 이론적으로 알아가보아요~',2,400,'woohyuk');

insert into book_club values(SEQ_book_club_club_no.nextval,'만화를 사랑하는 모임',8,'만화에 관심있는 성인분들','매주 일요일 오전 10시','국립도서관 광장 앞','모여서 만화읽으며 여유로운 시간보내요~',2,500,'soyoon');
...
insert into book_club values(SEQ_book_club_club_no.nextval,'추리좋아 제비추리말고',5,'명탐정이신 성인분들','둘째주, 넷째주 토요일 오후 5시','서울시 강남구 카페','스릴러, 추리소설을 좋아한다면 얼른 신청해주세요!',5,700,'hyeonjeong');
insert into book_club values(SEQ_book_club_club_no.nextval,'허구에서의 삶',5,'소설을 읽으며 힐링하시는 성인분들','둘째주, 넷째주 토요일 오후 5시','서울시 강남구 카페','허구속에서의 삶도 가끔은 마음의 힐링이 될 때가 있지않나요? 다들 빠져봅시당~',5,700,'woohyuk');
insert into book_club values(SEQ_book_club_club_no.nextval,'낭독회',5,'낭독에 관심있는 성인분들','둘째주, 넷째주 토요일 오후 5시','서울시 강남구 카페','대본들을 보며 낭독연습 및 토론해보아요~',5,700,'junghyun');
insert into book_club values(SEQ_book_club_club_no.nextval,'다독다독',5,'따뜻한 마음을 가진 성인','매주 금요일 오후 8시','서울시 강남구','좋은 글들 공유하며 서로 다독해주는 힐링 모임입니다~',6,700,'woohyuk');
